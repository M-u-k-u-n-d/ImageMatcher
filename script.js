    let cardsArray = [
        {
            'name': 'CSS',
            'img': 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/70/Devicon-css3-plain.svg/2048px-Devicon-css3-plain.svg.png',
        },
        {
            'name': 'HTML',
        ...
        {
            'name': 'JS',
            'img': 'https://logowik.com/content/uploads/images/3799-javascript.jpg',
        },
        {
            'name': 'Node',
